...
private:
	...
	{
		auto app = reinterpret_cast<VulkanBasics*>(glfwGetWindowUserPointer(window));
	...
	void pickPhysicalDevice()
	{
		...
		std::cout << "Using: " << chosenProps.deviceName << " as primary GPU" << std::endl;
	}
	...
	QueueFamilyIndices findQueueFamilies(VkPhysicalDevice device)
	{
		...
		for (const auto& queueFamily : queueFamilies)
		{
			...
			//Something currently breaks here
